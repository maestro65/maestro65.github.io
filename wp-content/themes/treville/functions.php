...
/**
 * Treville only works in WordPress 4.4 or later.
 */
...
function treville_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => esc_html__( 'Appears on Magazine Homepage template only. You can use the Magazine Posts widgets here.', 'treville' ),
...
function treville_google_fonts_url() {
	...
	return apply_filters( 'treville_google_fonts_url', $fonts_url );
}

	...
	class University_Hub_Featured_Page_Widget extends University_Hub_Widget_Base {
		...
		function __construct() {
			...
			$fields = array(
				...
				'featured_page' => array(
					'label'            => __( 'Выберите страницу:', 'university-hub' ),
					'type'             => 'dropdown-pages',
					'show_option_none' => __( '&mdash; выбрать &mdash;', 'university-hub' ),
					),
				'id_message' => array(
				...
				'content_type' => array(
					'label'   => __( 'Показать контент:', 'university-hub' ),
					'type'    => 'select',
					'default' => 'full',
					'options' => array(
						'excerpt' => __( 'Выдержка', 'university-hub' ),
						'full'    => __( 'Полностью', 'university-hub' ),
						),
					),
				...
				'featured_image' => array(
					'label'   => __( 'Миниатюра записи:', 'university-hub' ),
					'type'    => 'select',
					'options' => university_hub_get_image_sizes_options(),
					),
				'featured_image_alignment' => array(
					'label'   => __( 'Выравнивание изображения:', 'university-hub' ),
					'type'    => 'select',
					'default' => 'center',
			...
			parent::__construct( 'university-hub-featured-page', __( 'UH: Избранные страницы', 'university-hub' ), $opts, array(), $fields );
	...
	class University_Hub_Recent_Posts_Widget extends University_Hub_Widget_Base {
		...
		function __construct() {
			...
			$opts = array(
				...
				'description'                 => __( 'Отображает последние записи.', 'university-hub' ),
				'customize_selective_refresh' => true,
				);
			$fields = array(
				'title' => array(
				...
				'post_category' => array(
					'label'           => __( 'Выбирете категорию:', 'university-hub' ),
					'type'            => 'dropdown-taxonomies',
					'show_option_all' => __( 'Все категории', 'university-hub' ),
					),
				'post_number' => array(
				...
				'image_width' => array(
					'label'       => __( 'Ширина изображения:', 'university-hub' ),
					'type'        => 'number',
				...
				'disable_date' => array(
					'label'   => __( 'Отключить дату', 'university-hub' ),
					'type'    => 'checkbox',
					'default' => false,
					),
				);

			parent::__construct( 'university-hub-recent-posts', __( 'UH: Последние записи', 'university-hub' ), $opts, array(), $fields );

...
if ( ! function_exists( 'university_hub_footer_copyright' ) ) :
	...
	function university_hub_footer_copyright() {
		...
		// Powered by content.
		$powered_by_text = sprintf( __( ' %s', 'university-hub' ), '<a target="_blank" rel="designer" href="http://wenthemes.com/">WEN</a> / <a href="http://wp-templates.ru/" title="Шаблоны WordPress">WP</a> / <a href="http://builderbody.ru/" rel="nofollow" title="Бодибилдинг и фитнес - упражнения, тренировки, спортивное питание" target="_blank">Fitness</a>' );

		...
		<div class="entry-content">
			...
			<?php if ( 'full' === $archive_layout ) : ?>
				...
				the_content( sprintf(
					...
					wp_kses( __( 'Читать далее %s <span class="meta-nav">&rarr;</span>', 'university-hub' ), array( 'span' => array( 'class' => array() ) ) ),
					the_title( '<span class="screen-reader-text">"', '"</span>', false )
				) );
				?>
				<?php
					wp_link_pages( array(
						'before' => '<div class="page-links">' . esc_html__( 'Страницы:', 'university-hub' ),
						'after'  => '</div>',
					) );
				?>
		    <?php else : ?>

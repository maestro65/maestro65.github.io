						...
						<div class="latest-news-inner-wrapper">
							<div class="latest-news-thumb">
								...
								<div class="read-more-button">
									<a class="more" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Узнать больше', 'university-hub' ); ?></a>
								</div>
								...
								<div class="latest-news-meta">
									...
									<?php if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) : ?>
										<span class="comments-link">
											<?php comments_popup_link( esc_html__( '0 комментариев', 'university-hub' ), esc_html__( '1 Комментарий', 'university-hub' ), esc_html__( '% Комментариев', 'university-hub' ) ); ?>
										</span>
									<?php endif; ?>

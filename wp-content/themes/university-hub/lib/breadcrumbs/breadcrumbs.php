...
class Breadcrumb_Trail {
	...
	protected function set_labels() {
		...
		$defaults = array(
			'browse'              => esc_html__( 'Обзор:',                               'university-hub' ),
			'aria_label'          => esc_attr_x( 'Навигация', 'breadcrumbs aria label', 'university-hub' ),
			'home'                => esc_html__( 'Главная',                                  'university-hub' ),
			'error_404'           => esc_html__( '404 Страница не найдена',                         'university-hub' ),
			'archives'            => esc_html__( 'Архивы',                              'university-hub' ),
			// Translators: %s is the search query. The HTML entities are opening and closing curly quotes.
			'search'              => esc_html__( 'Результаты поиска для &#8220;%s&#8221;',   'university-hub' ),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Страница %s',                               'university-hub' ),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( 'Минуты %s',                             'university-hub' ),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( 'Недели %s',                               'university-hub' ),
